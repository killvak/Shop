//
//  GivenProductsViewController.swift
//  Benefactor
//
...
class GivenProductsViewController: HistoryListParentViewController {
    //MARK:- Services
    override func loadProducts()
    {
        self.startLoading()
        connectionHandler.getGivenProducts(completion: { (result) in
